# v2-metadata-regen — move V2 token metadata media from CDN to `ipfs://`
...
cd ../update-token-uri
export UPDATE_CONFIG=$PWD/../v2-metadata-regen/runs/<contract>/config.json RPC_URL=… VAULT_URL=… VAULT_API_KEY=…
