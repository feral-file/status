# phase2-step0 — rebuild the population, verify the link-layer assumption
...
```
RPC_URL=https://mainnet.infura.io/v3/<key> python3 tools/phase2-step0/check-base-uri.py \
