# phase2-step1 — size, mirror, and pin the CDN bytes
...
```
BUCKET=<origin-bucket> python3 tools/phase2-step1/size-dirs.py \
...
BUCKET=<origin-bucket> ./tools/phase2-step1/mirror-add-pin.sh \
